...
function update() {
    ...
    text = `<a href="https://partycorn.github.io/anilane/imggen/?title=${title}&ep=${episode}&image=${image}" target="_blank">Превью можно скачать здесь</a><div id="result"><b>${title}</b> ${episode>0?" <i>("+episode+" серия)</i>":""}<br><br>`;
